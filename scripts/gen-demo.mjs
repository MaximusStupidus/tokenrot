#!/usr/bin/env node
// Render `burnrate --demo` and convert the ANSI output into a self-contained SVG "terminal screenshot".
// Usage: node scripts/gen-demo.mjs > docs/demo.svg
import { execSync } from "node:child_process";

const raw = execSync("node bin/burnrate.js --demo", { env: { ...process.env, FORCE_COLOR: "1" } }).toString();

// 256-color / basic ANSI → hex (only the palette burnrate uses)
